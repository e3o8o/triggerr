 ...
 */
import type { CanonicalFlightData, CanonicalWeatherObservation } from "../models/canonical-models";
/**
...
export interface IFlightApiClient {
     ...
     */
    fetchFlight(flightNumber: string, date?: string): Promise<CanonicalFlightData | null>;
    /**
...
export interface IWeatherApiClient {
     ...
     */
    fetchWeather(lat: number, lon: number): Promise<CanonicalWeatherObservation | null>;
    /**
     * Checks if the API client is currently available and responsive.
     * @returns A promise that resolves to true if the service is healthy, false otherwise.
     */
